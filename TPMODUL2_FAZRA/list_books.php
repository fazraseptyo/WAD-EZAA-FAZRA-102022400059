...
$query = "
    SELECT books.id, books.title, categories.category_name AS category_name, books.author, books.stock
    FROM books
    LEFT JOIN categories ON books.category_id = categories.id
";

if (!empty($search)) {
    $query .= " WHERE books.title LIKE '%" . mysqli_real_escape_string($conn, $search) . "%'";
}
